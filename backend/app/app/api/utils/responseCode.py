...
def resp_208(*, data: Union[list, dict, str] = "208 Success", message: str = "Success") -> Response:
    return JSONResponse(
...
def resp_400(*, data: Union[list, dict, str] = "204 Success", message: str = "400 BAD REQUEST") -> Response:
    return JSONResponse(
